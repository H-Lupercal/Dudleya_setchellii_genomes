...
- Downloaded NCBI reference records:
  `reference/NC_085682.1.fetched.fa` and `reference/NC_085682.1.fetched.gb`
...
```bash
python3 dudleya_organelle_reference_verification/evidence/nc085682_chloroplast_comparison/run_comparison.py
```
