# Supplementary analysis report — supplement-20260824-v26
...
- chloroplast: 1111 fully called MAC≥2 SNPs; PC1–PC3 Procrustes r=0.8004, p=0.0001 (PASS_WITH_CAVEAT).
- mitochondria: 31 fully called MAC≥2 SNPs; PC1–PC3 Procrustes r=0.7977, p=0.0001 (FAIL).
...
- chloroplast: resolved=98.10%, partly resolved=0.59%, unresolved=1.30% (TREE_LIKE_NO_NETWORK); composition failures=1/276, >50% gaps/ambiguity=0.
...
substantially weaker than chloroplast and lay only 0.54 percentage points below
...
82.32% of quartets, with
3.59% partly resolved and
14.09% unresolved. This sensitivity does not
...
- Raw-read sketches are screens: sketch similarity alone is suspected, not confirmed identity,
  ...
  10 within-library controls but only 1
