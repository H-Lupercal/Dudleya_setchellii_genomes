#!/usr/bin/env python3
"""Run the concatenated cpDNA+mtDNA tree with 10,000 bootstrap replicates."""
...
OUTPUT_DIR = (
    ...
    "23_concatenated_bootstrap_phylogenetic_tree_10000"
)


def build_run_arguments() -> list[str]:
    """Return fixed settings for the combined 10,000-bootstrap tree run."""
    return [
        "--consensus-dir",
        CONSENSUS_DIR,
        "--run-label",
